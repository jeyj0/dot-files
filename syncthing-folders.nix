let
  ...
  framework-desktop = "jeyj0-framework-desktop";
  phone = "jeyj0-phone";
...
[
  {
    ...
    path = "01-projects";
    stignore = baseIgnore;
    devices = [ framework desktop framework-desktop ];
  }
  {
    id = "02-areas";
    label = "02-areas";
  ...
  }
  {
    ...
    stignore = baseIgnore;
    devices = [ framework desktop phone framework-desktop ];
  }
  {
  ...
  }
  {
    ...
    stignore = baseIgnore + ''
      .thumbnails
    '';
    devices = [ desktop phone framework-desktop ];
  }
]
